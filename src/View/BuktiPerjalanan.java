 ...
 * @author PancaSitorus
 */
public class BuktiPerjalanan extends javax.swing.JFrame {

    /**
     * Creates new form BuktiPerjalanan
     */
    public BuktiPerjalanan() {
        initComponents();
    }
        public void save(){
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuktiPerjalanan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuktiPerjalanan().setVisible(true);
            }
        });
    }
